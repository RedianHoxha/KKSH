...
<body>
  ...
  ?>
    ...
    <?php
                ...
                ?>
    <td class="text-left" colspan="3" style="text-align: center">Per daten qe ju keni zgjedhur nuk ka kurs ne orarin
      9:00 - 13:00!</td>
    </tr>
    <?php
      }
                    ...
                    ?>
    <td class="text-left" colspan="3" style="text-align: center">Per daten qe ju keni zgjedhur nuk ka vende te lira ne
      orarin 9:00 - 13:00!</td>
    </tr>
    <?php
    }
  } else {
