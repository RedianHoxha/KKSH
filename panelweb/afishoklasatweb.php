...
<body>
  ...
  ?>
            ...
            <td class="text-left" style="text-align: center;">
                <?php echo date('d/m/Y', strtotime($dataZgjedhur)) ?>
            </td>
            <td class="text-left" style="text-align: center;"><input type="radio" id="select" name="select"
                    value="<?php echo $rowkursi['idkursi'] ?>" required>Zgjidh</input></td>
        </tr>
        <?php
                      } else {
                    ?>
        <td class="text-left" colspan="3" style="text-align: center">Për datën që ju keni zgjedhur nuk ka kurs në orarin
            9:00 - 13:00!</td>
        </tr>
        <?php
                      }
        ...
        <td class="text-left" style="text-align: center;">Në datën qe ju keni zgjedhur nuk ka vende të lira pasi klasat
            janë mbushur. Data më e afert për klasa të lira është :
            <?php echo date('d/m/Y', strtotime($datakursitgjetur)) ?>
        </td>
        <td class="text-left" style="text-align: center;"><input type="radio" id="select" name="select"
                value="<?php echo $rowKkursigjetur['idkursi'] ?>" required>Zgjidh</input></td>
        </tr>
        <?php
                                  break;
                              }
                          ...
                          if ($gjetur != 1) {
                            ?>
        <td class="text-left" colspan="3" style="text-align: center">Në datën qe ju keni zgjedhur dhe në 3 ditët në
            vazhdim nuk ka vende të lira!</td>
        </tr>
        <?php
                          }
                      } else {
                            ?>
        <td class="text-left" colspan="3" style="text-align: center">Në datën që ju keni zgjedhur dhe në 3 ditët në
            vazhdim nuk është planifikuar kurs në orarin 09:00 - 13:00!</td>
        </tr>
        <?php
                      }
                  }
        ...
        <td class="text-left " style="text-align: center;"><input type="radio" id="select" name="select"
                value="<?php echo $rowkursidrek['idkursi'] ?>" required>Zgjidh</input></td>
        </tr>
        <?php
                      } else {
                    ?>
        ...
        <?php
                            ...
                            ?>
        <td class="text-left" colspan="3" style="text-align: center">Në datën që ju keni zgjedhur dhe në 3 ditët në
            vazhdim nuk është planifikuar kurs në orarin 13:00 - 17:00!</td>
        </tr>
        <?php
                      }
                  }
        ...
        <td class="text-left " style="text-align: center;"><input type="radio" id="select" name="select"
                value="<?php echo $rowkursimbasdit['idkursi'] ?>" required>Zgjidh</input></td>
        </tr>
        <?php
                      } else {
                ?>
        ...
        <?php
                        ...
                        ?>
        <td class="text-left" colspan="3" style="text-align: center">Në datën që ju keni zgjedhur dhe në 3 ditët në
            vazhdim nuk është planifikuar kurs në orarin 17:00 - 21:00!</td>
        </tr>
        <?php
                      }
                  }
        ...
        <?php
                    ...
                    ?>
        <td class="text-left" colspan="3" style="text-align: center">Për datën që ju keni zgjedhur nuk ka kurs! Kursi
            organizohet në këto ditë të javës: 'E Hënë', 'E Mërkurë', 'E Premte', 'E Shtunë', 'E Djelë'</td>
        </tr>
        <?php
          }
      } else {
        ...
        <td class="text-left " style="text-align: center;"><input type="radio" id="select" name="select"
                value="<?php echo $rowkursidiele['idkursi'] ?>" required>Zgjidh</input></td>
        </tr>
        <?php
                  } else {
                    ?>
        ...
        <?php
                        ...
                        ?>
        <td class="text-left" colspan="3" style="text-align: center">Në datën që ju keni zgjedhur dhe në 3 ditët në
            vazhdim nuk është planifikuar kurs në orarin 09:00 - 15:00!</td>
        </tr>
        <?php
                  }
        ...
        <?php
                        ...
                        ?>
        <td class="text-left" colspan="3" style="text-align: center">Data që ju keni zgjedhur nuk është e saktë. Kurset
            organizohen nga sot e ne vazhdim. Ju Faleminderit!</td>
        </tr>
        <?php
  }
    ?>
