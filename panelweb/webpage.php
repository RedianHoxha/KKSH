    ...
    <section class="get-in-touch">
        ...
        <div id="form" class="shadow p-3 mb-5 bg-white rounded">
            <form id="captcha_form" class="contact-form row g-3" action="rregjistroweb.php" method="POST">
                ...
                <div class="col-md-4 position-relative">
                    <label for="validationTooltip02" class="form-label">Mbiemri</label><span
                        style="color:#ff0000">*</span>
                    <input type="text" class="form-control" name="surname" id="surname" require
                        placeholder="Mbiemri...">
                ...
                <div class="col-md-6 position-relative">
                    ...
                    <select id="city" name="city" class="form-select" require onchange="showclassCity(this.value)">
                        ...
                        <option value="<?php echo $row['EmriDeges']; ?>">
                ...
                <div class="col-md-6 position-relative">
                    ...
                    <input type="date" class="form-control" name="datakursit" id="datakursit"
                        min="<?php echo date('Y-m-d') ?>" require onchange="showclass(this.value)">
