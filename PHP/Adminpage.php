...
<!DOCTYPE html>
    ...
    <body>
            ...
            <div id="mainaddbutton">
                    ...
                    <button onclick="location.href = '../HTML/Shtoklase.php';" id="addButton" >Shto Klase</button>
                    <button onclick="location.href = '../HTML/Shtodege.php';" id="addButton" >Shto Dege</button>
            </div>  
            <div id="filebutton">
