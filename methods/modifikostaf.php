...
<body>
    <div id="top-page">
        <button class="btn btn-secondary" onclick="location.href = '../admin/adminpageconfirm.php';" id="myButton">
            Home</button>
        ...
        <form action="../dao/modifikostafdao.php?id=<?php echo $iduseriToModify ?>" method="POST">
            ...
            <div id="tedhenapersonale">
                ...
                <input class="input100" id="emri-txt" type="text" name="emri-txt"
                    value="<?php echo decrypt($rowUserToModify['Emri']); ?>" required><br>

                <p id="mbiemri">Mbiemri</p>
                <input class="input100" id="mbiemri-txt" type="text" name="mbiemri-txt"
                    value="<?php echo decrypt($rowUserToModify['Mbiemri']); ?>" required><br>

                <p id="id">ID Personale</p>
                <input class="input100" id="id-txt" type="text" name="id-txt"
                    value="<?php echo decrypt($rowUserToModify['ID']); ?>" require>
            </div><br><br>
            <div id="tedhenalogimi">
                <p id="username">Username</p>
                <input class="input100" id="username-txt" type="text" name="username-txt"
                    value="<?php echo decrypt($rowUserToModify['Username']); ?>" required>

                <p id="password">Password</p>
                <input class="input100" id="password-txt" type="password" name="password-txt"
                    value="<?php echo decrypt($rowUserToModify['Password']); ?>" required><br><br>
                ...
                <select class="form-select" aria-label="Default select example" id="roli" name="roli" required>
                    <option selected="selected" value="<?php echo decrypt($rowUserToModify['Roli']); ?>">
                        <?php echo decrypt($rowUserToModify['Roli']); ?>
                    </option>
            ...
            <div id="tedhenakontakti">
                ...
                <input class="input100" id="tel-txt" type="text" name="tel-txt"
                    value="<?php echo $rowUserToModify['Telefoni']; ?>" required><br>
                ...
                ?>
                    <option selected="selected" value="<?php echo decrypt($row['EmriDeges']); ?>">
                        <?php echo decrypt($row['EmriDeges']); ?>
                    </option>
                    <?php } else { ?>
                    <option value="<?php echo decrypt($row['EmriDeges']); ?>">
                        <?php echo decrypt($row['EmriDeges']); ?>
                    </option>
                    <?php }
                } ?>
