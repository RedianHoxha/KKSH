  ...
  ?>
    ...
    <?php
        $nrRendor = $nrRendor + 1;
            ...
            ?>
    <td class="text-left" colspan="9" style="text-align:center">Per klasen qe keni zgjedhur ne kete date nuk eshte
      rregjistruar asnje kursant.Ju lutem zgjidhni nje date tjeter</td>
    </tr>
    <?php
    }
  } else {
