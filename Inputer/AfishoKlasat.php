...
<body>
  ...
  ?>
      ...
      <td class="text-left">
        <?php echo decrypt($emriInstruktori) . " " . decrypt($mbiemriInstruktori) ?>
      </td>
      <td class="text-left">
        <?php echo $kursantet ?>
      </td>
      ...
      <td class="text-left"><input type="radio" name="select" value="<?php echo $idKursi ?>">Choose</radio>
      </td>
    </tr>
    <?php
      }
            ...
            ?>
    <td class="text-left" colspan="7" style="text-align:center">Per daten qe ju keni zgjedhur nuk ka vende te lira! Ju
      lutem zgjidhni nje date tjeter</td>
    </tr>
    <?php
    }
  } else {
