...
<body>
    ...
    <table id="tabela-kursanteve" class="table table-bordered">
        ...
        <tr>
            <?php
               $today = date('Y-m-d');
               $sqlquery = "SELECT * FROM kursantet WHERE Datakursit >='$today' AND Statusi = 'pabere' ORDER BY DataRregjistrimit DESC";
            ...
            <td class="text-left">
                <?php echo date('d/m/Y', strtotime($row['Datelindja'])); ?>
            </td>
            <td class="text-left">
                <?php echo date('d/m/Y', strtotime($row['Datakursit'])); ?>
            </td>
            <td class="text-left">
                <?php echo $row['Orari']; ?>
            </td>
            ...
            <td class="text-left"><button class="btn btn-success"
                    onclick="location.href = '../methods/ndryshorregjistrimin.php?id=<?php echo $row['ID']; ?>'">Ndrysho</button><button
