...
<body>
    <div id="top-page">
        <div id="logout">
            ...
            <button class="btn btn-secondary" onclick="location.href = 'shtokursantpakurs.php';"
                id="myButton">Rregjistro Kursant</button>
            <button class="btn btn-secondary" onclick="location.href = 'confirmpageold.php';"
                id="myButton">Search</button>
    ...
    <div id="selection-criteria">
        <div class="form-field col-lg-3 ">
            ...
            while ($row = mysqli_fetch_array($qytetet)) {
                $emriKlases = $row['Emri'];
            ?>
                <option value="<?php echo decrypt($emriKlases) ?>">
        ...
        <div class="form-field col-lg-6 ">
            ...
            <select class="form-select" aria-label="Default select example" onchange=showklasCoursant() id="orari"
                name="orari" style="width:30%;" required>
