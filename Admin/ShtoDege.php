    ...
    <div id="Form">
        <form action="../dao/rregjistrodege.php" method="POST">
            ...
            <div id="tedhenapersonale">
                ...
                <input class="input100" id="emrideges-txt" type="text" name="emrideges-txt" placeholder="..."
                    autocomplete="off" required><br>
            </div><br><br>
            <div>
                <div id="adresa">
                    <p id="adresa">Adresa ne Google Maps</p>
                    <input class="input100" id="adresa-txt" type="text" name="adresa-txt" placeholder="..."
                        autocomplete="off" required><br>
                </div><br><br>
                <div>
