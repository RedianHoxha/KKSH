...
<body>
    ...
    <div id="bottom">
        <div id="Staf">
            <div>
                <button class="btn btn-success" onclick="location.href = 'shtostaf.php';" id="addbutton">Shto
                    Staf</button>
            </div>
            <div id="tabela">
                ...
                <table id="stafi" class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo decrypt($row['Roli']); ?>
                        </td>
                        <td>
                            <?php echo decrypt($row['Degakupunon']); ?>
                        </td>
                        <td>
                            <?php echo decrypt($row['Username']); ?>
                        </td>
                        <td>
                            <?php echo $row['Telefoni']; ?>
                        </td>
                        <td class="text-left"><button class="btn btn-info"
                                onclick="location.href = '../methods/modifikostaf.php?id=<?php echo $row['UniqueId']; ?>'">Modifiko</button><button
                                class="btn btn-danger"
                                onclick="location.href = '../methods/fshiuser.php?id=<?php echo $row['UniqueId']; ?>'">Fshi</button>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
        ...
        <div id="Klase">
            <div id="tabela">
                <div>
                    <button class="btn btn-success" onclick="location.href = 'shtoklase.php';" id="addButton">Shto
                        Klase</button>
                </div>
                <!-- <script>
                ...
                <table id="klasa" class="table table-bordered">
                    ...
                    ?>
                        ...
                        <td>
                            <?php echo decrypt($degaRow['EmriDeges']); ?>
                        </td>
                        <td>
                            <?php echo $row['Kapaciteti']; ?>
                        </td>
                        <td><button class="btn btn-danger"
                                onclick="location.href = '../dao/fshiklase.php?id=<?php echo $row['ID']; ?>'">Fshi</button>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
        ...
        <div id="Dege">
            <div>
                <button class="btn btn-success" onclick="location.href = 'shtodege.php';" id="addButton">Shto
                    Dege</button>
            </div>
            <div id="tabela">
                <table id="dega" class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-danger"
                                onclick="location.href = '../dao/fshidege.php?id=<?php echo $row['IDQyteti']; ?>'">Fshi</button>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
