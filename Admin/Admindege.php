...
<body>
    <div id="add_button">
        <button class="btn btn-success" onclick="location.href = 'shtoplanifikim.php';" id="addbutton">Shto
            Planifikim</button>
    ...
    <div id="organisation_table">
        <div>
            <form action="searchcourse.php" method="POST">
                <input class="form-group mx-sm-5 mb-4" type="text" name="search" id="search"
        ...
        <div id="tabela">
            <table id="organizim_javor" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $kursantetGjetur ?>
                    </td>
                    <td class="text-left"><button class="btn btn-secondary"
                            onclick="location.href = '../methods/ndryshoplanifikim.php?id=<?php echo $row['idkursi']; ?>'">Modifiko</button><button
                            class="btn btn-danger"
                            onclick="location.href = '../methods/fshiplanifikim.php?id=<?php echo $row['idkursi']; ?>'">Fshi</button>
                    </td>
                </tr>
                <?php } ?>
            </table>
