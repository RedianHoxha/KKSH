    ...
    <div id="Form">
        <form action="../dao/rregjistroklas.php" method="POST">
            ...
            <div id="tedhenapersonale">
                ...
                <input class="input100" id="emriklases-txt" type="text" name="emriklases-txt" placeholder="..."
                    autocomplete="off" required><br>

                <p id="kapaciteti">Kapaciteti</p>
                <input class="input100" id="kapaciteti-txt" type="number" name="kapaciteti-txt" autocomplete="off"
                    required><br>
            </div><br><br>
            <div id="vendodhja">
