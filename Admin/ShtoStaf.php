    ...
    <div id="Form">
        <form action="../dao/rregjistrostaf.php" method="POST">
            ...
            <div id="tedhenapersonale">
                <p id="emri">Emri</p>
                <input class="input100" id="emri-txt" type="text" name="emri-txt" placeholder="..." autocomplete="off"
                    required><br>

                <p id="mbiemri">Mbiemri</p>
                <input class="input100" id="mbiemri-txt" type="text" name="mbiemri-txt" placeholder="..."
                    autocomplete="off" required><br>

                <p id="id">ID Personale</p>
                <input class="input100" id="id-txt" type="text" name="id-txt" placeholder="..." autocomplete="off"
                    required>
            </div><br><br>
            <div id="tedhenalogimi">
                <p id="username">Username</p>
                <input class="input100" id="username-txt" type="text" name="username-txt" placeholder="..."
                    autocomplete="off" required>

                <p id="password">Password</p>
                <input class="input100" id="password-txt" type="password" name="password-txt" placeholder="..."
            ...
            <div id="tedhenakontakti">
                ...
                <input class="input100" id="tel-txt" type="text" name="tel-txt" placeholder="..." autocomplete="off"
                    required><br>
