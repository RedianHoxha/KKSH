...
<body>
    <div id="info">
        <p>Ky instruktor ka trajnuar
            <?php echo $shumaTotale ?> Kursante
        </p>
    </div>
    <div id="tabela">
        <script>
    ...
    if (mysqli_num_rows($result) != 0) {
        while ($row = mysqli_fetch_array($result)) {
            ...
            <?php
                        ...
                        ?>
            <td class="text-left" colspan="7" style="text-align:center">Per Instruktorin e zgjedhur nuk ka ndonje te
                dhene ne sistem! Zgjidhni nje Instruktor tjeter.</td>
            </tr>
            <?php
    }
} else {
