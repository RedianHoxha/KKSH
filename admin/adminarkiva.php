...
<body>
    <div id="logout">
        <button class="btn btn-secondary" onclick="location.href = 'adminpageconfirm.php';" id="myButton">Faqja
            Kryesore</button>
    ...
    <div id="search">
        <form action="adminsearcharkiva.php" method="POST">
    ...
    <table id="tabela-kursanteve" class="table table-bordered">
        ...
        <tr>
            <?php
               $sqlquery = "SELECT * FROM  kursantet WHERE Statusi NOT IN ('pabere')";
