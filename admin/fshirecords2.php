...
<body>
    ...
    <table id="tabela-kursanteve" class="table table-bordered">
        ...
        ?>
            <td class="text-left">
                <?php echo $rowKasiKursantesh['idkursi'] ?>
            </td>
            <td class="text-left">
                <?php echo decrypt($rowKasiKursantesh['idkursanti']) ?>
            </td>
            <td class="text-left">
                <?php echo $rowKasiKursantesh['idkursanti'] ?>
            </td>
            <td class="text-left">
                <?php echo $rowKasiKursantesh['statusi'] ?>
            </td>
        </tr>
        <?php
                    }
