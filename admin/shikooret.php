...
<body>
    <div id="add_button">
        ...
        <button class="btn btn-success" onclick="location.href = 'admindege.php';" id="addbutton">Shiko
            Planifikimet</button>
        <button class="btn btn-info" onclick="location.href = 'shtoplanifikim.php';" id="addbutton">Shto
            Planifikim</button>
        ...
        <div id="dorpdown">
            <div class="form-field col-lg-6 ">
                <select class="form-select" aria-label="Default select example" id="instruktori" name="instruktori"
                    onchange=showInformationInstruktor(this.value)>
                    <?php
            ...
            <div class="form-field col-lg-6 " id="muajDropDown">
                <!-- <label class="label" for="muaji" id="muaji">Muaji</label> -->
                <select class="form-select" aria-label="Default select example" id="muaji" name="muaji"
                    onchange=showInformationMuaj(this.value)>
